...
namespace CP_SDK_BS.UI
{
        ...
        where t_Base : HMUIViewFlowCoordinator<t_Base>
    {
        ...
        /// </summary>
        /// <typeparam name="t_ViewController">View type</typeparam>
        /// <returns></returns>
        public static t_ViewController CreateViewController<t_ViewController>()
            where t_ViewController : HMUI.ViewController
            => HMUIUIUtils.CreateViewController<t_ViewController>();
        /// <summary>
        /// Destroy view controller
        /// </summary>
        /// <typeparam name="t_ViewController">View type</typeparam>
        /// <param name="p_ViewController">View to destroy</param>
        public static void DestroyViewController<t_ViewController>(ref t_ViewController p_ViewController)
            where t_ViewController : HMUI.ViewController
        {
            if (p_ViewController)
            {
