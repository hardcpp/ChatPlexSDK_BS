...
namespace CP_SDK_BS.Game
{
    ...
    public class Logic
    {
        ...
        private static void SceneManager_activeSceneChanged(UnityEngine.SceneManagement.Scene p_Current, UnityEngine.SceneManagement.Scene p_Next)
        {
            ...
            {
                CP_SDK.ChatPlexSDK.Logger.Error("[CP_SDK_BS.Game][Logic.SceneManager_activeSceneChanged] Error :");
        ...
        private static void OnMenuSceneActive()
        {
            ...
            {
                CP_SDK.ChatPlexSDK.Logger.Error("[CP_SDK_BS.Game][Logic.OnMenuSceneActive] Error :");
                CP_SDK.ChatPlexSDK.Logger.Error(p_Exception);
            }
        }
        /// <summary>
        ...
        private static void OnMenuSceneLoadedFresh(SceneTransitionType p_SceneTransitionType, ScenesTransitionSetupDataSO p_Object, DiContainer p_DiContainer)
        {
            ...
            {
                CP_SDK.ChatPlexSDK.Logger.Error("[CP_SDK_BS.Game][Logic.OnMenuSceneLoadedFresh] Error :");
                CP_SDK.ChatPlexSDK.Logger.Error(p_Exception);
            }
        }
        /// <summary>
        ...
        private static void OnGameSceneActive()
        {
            ...
            {
                CP_SDK.ChatPlexSDK.Logger.Error("[CP_SDK_BS.Game][Logic.OnGameSceneActive] Error :");
                CP_SDK.ChatPlexSDK.Logger.Error(p_Exception);
            }
        }
